var mainApp = angular.module('mainApp', [ 'ngRoute', 'ngCookies', 'ngAnimate', 'mgcrea.ngStrap', 'ngFileUpload', 'restServices', 'ngProgress',
...
mainApp.controller('mainController', function($rootScope, $scope, $aside) {
	...
	$rootScope.showLoginSlidePanel = function() {
		$rootScope.showSlidePanel("app/login/slide-login.html", "Login", "300px");
	};
